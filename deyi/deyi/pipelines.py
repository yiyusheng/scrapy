...
class deyiWebMySQLPipeline(object):
    def process_item(self,item,spider):
        dbObject = dbHandle()
        ...
        try:
            cursor.execute(sql,(item['title'],item['uname'],item['time'],item['reply_count'],item['create_time'],spider.name,item['url'],item['view_count']))
