...
class RightSpider(CrawlSpider):
    name = 'Right'
    allowed_domains = ['right.com.cn']

    def start_requests(self):
        urls = ['https://www.right.com.cn/forum/forum.php?mod=forumdisplay&fid=88&orderby=dateline&filter=author&orderby=dateline&page=' + str(i) for i in range(1,2)]
        for url in urls:
    ...
    def parse(self,response):
        ...
        for it in rx:
           ...
           item['url'] = it.xpath('@id').extract()[0].replace('normalthread_','https://www.right.com.cn/forum/forum.php?mod=viewthread&tid=')
